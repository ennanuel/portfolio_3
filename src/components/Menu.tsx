                    ...
                    <div className="flex items-center gap-2 sm:gap-4">
                        {
                            ['Linkedin', 'Github', 'Instagram'].map((item, index) => (
                                ...
                                >
                                    <Button text={item} className="font-mono uppercase text-sm sm:text-base px-4 min-h-[36px] rounded-full sm:rounded-md border border-brown-600 text-brown-500"></Button>
                                </li>
                            ))
                        }
                    </div>
